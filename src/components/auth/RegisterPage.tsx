...
import { Eye, EyeOff, Mail, Lock, User, BarChart3, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Join ForexTrade Pro</h1>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>© 2025 ForexTrade Pro. All rights reserved.</p>
          <p className="mt-1">Demo trading platform for educational purposes only.</p>
        </div>
      </div>
    </div>
  );
